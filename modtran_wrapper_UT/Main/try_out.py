...
#execute.execute_modtran('H2OSTR', beginning = 2, end = 3, step = 1, list_values = [])
...
test = Tape7.read_tape7(r'C:\Users\ried_st\OneDrive\Austausch\Programming_2\working_directory\Test', 'test_modtran_returns', 'y')
#print (test[3])
